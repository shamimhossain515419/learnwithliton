          ...
          <div className=" md:col-span-2 w-full">
            <div className=" ">
              <div className="player-wrapper">
                <ReactPlayer
                  fallback={
                    <p className="text-[20px] flex justify-center w-full h-full items-center text-blue-600 ">
                      {' '}
                      loading...{' '}
                    </p>
                  }
                  playIcon={
                    <div className=" bg-white  rounded-full   p-7 cursor-pointer">
                      <FaPlay size={30} className="text-blue-500" />
                    </div>
                  }
                  playing={true}
                  light={true}
                  ...
                  url="https://player.vimeo.com/941767784"
              ...
              {/* video description  */}
              <div>
                <button className=" text-[#E2E8F0] py-3 px-4 border-b-2 border-[#0284C7] bg-[#1E293B]">
                  ভিডিও ডেসক্রিপশন
                </button>
                <div className=" h-[1px]  bg-[#F8FAFC14] w-full"> </div>
              </div>
              <div className=" py-5">
                <h1 className="  leading-[28px] text-[16px]  font-medium text-[#FFF]">
                  1.7 Action Payloads and Creators
                </h1>
                <p className=" leading-[24px] p-0 primaryColor text-start text-[13px]">
                  Action Creators Why need
                </p>
              </div>
              <div>
                <div className=" h-[1px]  bg-[#F8FAFC14] w-full"> </div>
                <p className=" text-start pt-5  leading-[28px]   primaryColor text-[16px]">
                  এই ভিডিও তে আমরা বুঝবো কি ভাবে প্যারামিটারের মাধ্যমে ডাইনামিক
                  ভ্যালু পাস করা যায় এবং সেই অনুযায়ী ডাইনামিক ভাবে ইনক্রিমেন্ট ও
                  ডিক্রিমেন্ট করতে পারি এপ্লিকেশনের চাহিদা অনুযায়ী।
                </p>
              </div>
            </div>
          </div>
          <div className="  w-full md:col-span-1">
            ...
            <div className="  w-full    border-2 border-[#f8fafc0f] rounded-[8px] p-2">
              <div className=" w-full flex items-center gap-2 bg-[#1E293B] p-3  rounded-[4px] ">
                <IoMdSearch className=" text-white-base" size={18} />
                <input
                  className=" w-full bg-transparent outline-none border-none  primaryColor"
                  type="text"
              ...
              <div className=" mt-4">
                <div>
                  <h1 className=" text-[#FFFFFF] text-[14pxs] ">
                    {' '}
                    1/14 টি মডিউল শেষ করেছেন · অগ্রগতি 7.14%
                  </h1>
                  <p className=" text-start text-[13px] text-[#4B5563]  leading-3">
                    ...
                    <div key={index}>
                      <div>
                        <div
                          ...
                          className={`flex ${
                            active == index
                              ? 'bg-[#0284C7] duration-200 text-white-base '
                              : 'text-[#94A3B8] bg-transparent'
                          }  cursor-pointer  p-2 justify-start gap-3 `}
                        >
                          ...
                          <div>
                            <h2 className=" cursor-pointer  text-[17px]   font-medium leading-[ 18.4px]">
                              {' '}
                              {item?.name}{' '}
                            </h2>
                            <p className="  text-[13px]">
                              {' '}
                              {item?.videoTime} <span> | ডেডলাইন: </span>{' '}
                              {item?.dataLine}{' '}
                            </p>
                          </div>
                        </div>
                        <Collapse isOpened={active == index}>
                          <div>
                            {item?.subClass?.map((item, index) => (
                              <div
                                className=" pl-5  py-3 cursor-pointer border-b border-[#F8FAFC14] hover:bg-[#F8FAFC14] duration-200"
                                key={index}
                              >
                                <div className=" flex items-start justify-start gap-3">
                                  ...
                                  <div className=" -mt-2">
                                    <h4 className="text-[#cfdbed] text-[14px] font-medium">
                                      {' '}
                                      {item?.title}{' '}
                                    </h4>
