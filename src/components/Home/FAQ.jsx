          ...
          <div className=" grid md:grid-cols-2 gap-10 ">
            <div className="  flex justify-start items-end">
              <div>
                ...
                <div className="max-w-[450px]">
                  <SectionTitle
                    size={'text-[34px]'}
                    title_1={'সচরাচর জানতে চাওয়া'}
                    title_2={'প্রশ্নের উত্তর'}
                  ></SectionTitle>
                </div>

                <div>
                  <p className=" text-[#94A3B8]    text-[18px] font-normal mt-4 ">
            ...
            <div>
              ...
              <div className=" h-[400px] overflow-y-scroll FAQscroll">
                {FAQData?.map(item => (
                  <div
                    className=" px-2  border-b border-[#F8FAFC14]"
                    key={item?.id}
                  >
                    <div
                    ...
                    <div className="">
                      <Collapse isOpened={active === item?.id}>
                        <p className="text-[#94A3B8] leading-[24px]  duration-500 text-[16px] font-normal py-2">
                          {' '}
                          {item?.paragraph}{' '}
                        </p>
                      </Collapse>
