                         ...
                         <div className=' xl:col-span-3 '>
                              <div className=' grid   sm:grid-cols-2 xl:grid-cols-3 gap-5'>
                                   ...
                                   <div className=' hover:scale-105 duration-300 rounded-lg bg-black p-4  shadow-md' style={{
                                        ...
                                        <h1 className=' heading-16 text-center text-[#E2E8F0] py-1'> বেসিক HTML</h1>
                                        <p className=' heading-14 py-1 text-center '>HTML সম্পর্কে প্রাথমিক ধারণা থাকতে হবে।</p>
                                        <div className=' flex justify-center items-center'>
                                             <div className=' text-center  inline-block'>
                                                  <Link className=' mt-3   rounded-[32px]  text-[#38BDF8] py-2 px-4    border-2 border-[#38BDF8] flex items-center justify-center gap-2' href={'/'}>
                                                       <BiSolidEdit size={20} />
                                                       <span className=' text-[14px] font-medium'>এখান থেকে শিখুন</span>
                                                  </Link>
                                   ...
                                   <div className='  hover:scale-105 duration-300 rounded-lg bg-black p-4   shadow-md' style={{
                                        ...
                                        <p className=' heading-14 py-1 text-center '>CSS সম্পর্কে প্রাথমিক ধারণা থাকতে হবে।</p>
                                        <div className=' flex justify-center items-center'>
                                             <div className=' text-center  inline-block'>
                                                  <Link className=' mt-3   rounded-[32px]  text-[#38BDF8] py-2 px-4    border-2 border-[#38BDF8] flex items-center justify-center gap-2' href={'/'}>
                                   ...
                                   <div className='rounded-lg bg-black p-4  hover:scale-105 duration-300 shadow-md' style={{
                                        boxShadow: '0px 0px 4px 0px rgba(255, 255, 255, 0.25)',
                                   }}>
                                        <div className=' text-center'>
                                        ...
                                        <p className=' heading-14 py-1 text-center '>বেসিক ও মডার্ন JavaScript সম্পর্কে ধারণা থাকতে হবে।</p>
                                        <div className=' flex justify-center items-center'>
                                             <div className=' text-center  inline-block'>
                                                  <Link className=' mt-3   rounded-[32px]  text-[#38BDF8] py-2 px-4    border-2 border-[#38BDF8] flex items-center justify-center gap-2' href={'/'}>
                                                       <BiSolidEdit size={20} />
                                   ...
                                   <div className='rounded-lg bg-black p-4  hover:scale-105 duration-300 shadow-md' style={{
                                        ...
                                        <h1 className=' heading-16 text-center text-[#E2E8F0] py-1'> বেসিক React.js</h1>
                                        <p className=' heading-14 py-1 text-center '>React.js সম্পর্কে প্রাথমিক ধারণা থাকতে হবে।</p>
                                        <div className=' flex justify-center items-center'>
                                             <div className=' text-center  inline-block'>
                                                  <Link className=' mt-3   rounded-[32px]  text-[#38BDF8] py-2 px-4    border-2 border-[#38BDF8] flex items-center justify-center gap-2' href={'/'}>
                                                       <BiSolidEdit size={20} />
                                   ...
                                   <div className='rounded-lg bg-black p-4  hover:scale-105 duration-300 shadow-md' style={{
                                        ...
                                        <h1 className=' heading-16 text-center text-[#E2E8F0] py-1'> বেসিক Git/GitHub</h1>
                                        <p className=' heading-14 py-1 text-center '>Git/GitHub সম্পর্কে প্রাথমিক ধারণা থাকতে হবে।</p>
                                        <div className=' flex justify-center items-center'>
                                             <div className=' text-center  inline-block'>
                                                  <Link className=' mt-3   rounded-[32px]  text-[#38BDF8] py-2 px-4    border-2 border-[#38BDF8] flex items-center justify-center gap-2' href={'/'}>
                                                       <BiSolidEdit size={20} />
                                   ...
                                   <div className='rounded-lg bg-black p-4  hover:scale-105 duration-300 shadow-md' style={{
                                        ...
                                        <p className=' heading-14 py-1 text-center '>VS Code এডিটরে কাজ করার অভ্যাস থাকতে হবে।</p>
                                        <div className=' flex justify-center items-center'>
                                             <div className=' text-center  inline-block'>
                                                  <Link className=' mt-3   rounded-[32px]  text-[#38BDF8] py-2 px-4    border-2 border-[#38BDF8] flex items-center justify-center gap-2' href={'/'}>
                                                       <BiSolidEdit size={20} />
