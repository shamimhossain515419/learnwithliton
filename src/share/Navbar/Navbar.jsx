...
const Navbar = () => {
  ...
  return (
    <div>
      <Container>
        <nav
          className={`px-2 py-3 z-50  border-b-2   border-[#1F2937]   secondBg  shadow fixed top-0 left-0 w-full overflow-hidden `}
        >
          <Container>
            <div className=" ">
