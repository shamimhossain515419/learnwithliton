                    ...
                    <div className=' md:grid md:grid-cols-2 gap-3 xl:gap-6 py-8'>
                         <div>
                              <div className=" w-full py-3">
                                   ...
                                   <input className=" w-full md:w-[80%] text-[#64748B] md:pl-6 my-2 outline-none border-none p-3 rounded-[4px] bg-[#1E293B] " type="text" name="" id="" placeholder="Ex: MD. LITON HOSSAIN" />
                              </div>
