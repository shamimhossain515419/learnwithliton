...
//  create method learning_objects
export async function POST(req, res, next) {
  try {
    const body = await req.json();
    const result = await prisma.learning_objects.create({ data: body });
...
export async function PUT(req, res) {
  try {
    ...
    const result = await prisma.learning_objects.update({
      where: { id },
      data: reqBody,
    });
...
export async function DELETE(req, res) {
  try {
    ...
    if (!findCourse) {
      return NextResponse.json({
        status: "fail",
        data: "learning_objects not found",
      });
    }
    const result = await prisma.learning_objects.delete({
      where: { id },
    });
    return NextResponse.json({ status: "success", data: result });
  } catch (error) {
