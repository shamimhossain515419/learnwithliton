          ...
          <div className="  w-full md:w-[250px] md:border-r-2 border-[#F8FAFC14]">
            <div className="sm:w-10/12 ">
              <Link
                ...
                className={` ${
                  pathname == '/account'
                    ? 'bg-[#1E293B] text-[#0284C7]'
                    : 'text-[#94A3B8]'
                } flex items-center gap-3  my-2 hover:bg-[#1E293B] rounded-[3px]  py-2 px-2 `}
              >
              ...
              <Link
                href={'/account/enrolment'}
                className={` ${
                  pathname == '/account/enrolment'
                    ? 'bg-[#1E293B] text-[#0284C7]'
                    : 'text-[#94A3B8]'
                } flex items-center gap-3  my-2 hover:bg-[#1E293B] rounded-[3px]  py-2 px-2 `}
              >
