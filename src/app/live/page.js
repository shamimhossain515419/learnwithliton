               ...
               <Container>
                    <div className='  grid  grid-cols-1 md:grid-cols-2 xl:grid-cols-3 md:gap-3 xl:gap-7  '>
                         <div className=' hover:scale-105 duration-300 border border-[#F8FAFC14] rounded-[8px] overflow-hidden'>
                              ...
                              <div className='border-t p-2  md:px-4 border-[#F8FAFC14]'>
                                   <div className='flex justify-center items-center  py-6 '>
                                        <button className=' rounded-[8px] w-full text-[16px] text-[#fff]  font-medium px-8 py-[10px] hover:bg-[#07B5D5] bg-[#0284C7]'>
                         ...
                         <div className='  hover:scale-105 duration-300  border border-[#F8FAFC14] rounded-[8px] overflow-hidden'>
                              ...
                              <div className='border-t p-2  md:px-4 border-[#F8FAFC14]'>
                                   <div className='flex justify-center items-center  py-6 '>
                                        <Link href={'/'} className=' rounded-[8px] hover:bg-[#07B5D5] w-full text-[16px] text-[#fff]  font-medium px-8 py-[10px] bg-[#0284C7]'>
                                             আরো সাকসেস স্টোরি দেখুন
                                        </Link>
                                   </div>
                              </div>
                         ...
                         <div className='  hover:scale-105 duration-300  border border-[#F8FAFC14] rounded-[8px] overflow-hidden'>
                              ...
                              <div className='border-t p-2  md:px-4 border-[#F8FAFC14]'>
                                   <div className='flex justify-center items-center  py-6 '>
                                        <Link href={'/'} className=' hover:bg-[#07B5D5] rounded-[8px] w-full text-[16px] text-[#fff]  font-medium px-8 py-[10px] bg-[#0284C7]'>
                                             আরো সাকসেস স্টোরি দেখুন
                                        </Link>
                                   </div>
                              </div>
